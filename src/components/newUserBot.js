  ...
  return (
    ...
    >
      <Typography variant="subtitle1">
        {userStatus === 'new' &&
          'I am Change360, your personal AI fitness trainer. Would you like to join a meal plan?'}
            {userStatus === 'new' && (
            <>
        ...
        */}
        {userStatus === 'mealplan' &&
          'Do you want to generate a new meal plan?'}
        {userStatus === 'userform' &&
          'Please provide some general information to generate your meal plan.'}
        {userStatus === 'tips' &&
          'Here are some tips to help you stay on track with your fitness goals.'}
        {userStatus === 'return' &&
          'Welcome back! Do you want to view your meal plans or sign up for an additional plan?'}
      </Typography>
